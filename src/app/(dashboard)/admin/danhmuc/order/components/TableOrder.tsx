...
interface IOrder {
  ...
  total_amount: number;
  order_state: string;
  // Trường Customer có thể không tồn tại trong một số responses từ API
  Customer?: { name: string; email: string };
  // Trường name và email có thể trực tiếp trong đối tượng đơn hàng trong một số responses
  name?: string;
  email?: string;
                ...
                return (
                  ...
                  >
                    ...
                    <TableCell className="text-black">
                      {item.Customer ? item.Customer.name : (item.name || "Khách hàng")}
                    </TableCell>
                    <TableCell className="text-black">
